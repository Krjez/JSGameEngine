...
class Enemy extends GameObject
{
    ...
    update(deltaTime) {
        ...
        {
            //TODO the collision in player unnecessary - think which place better or even separate
            player.collidedWithEnemy();
        }

        //TODO was in the code from naoise, dont think it does anything - check later with/without
        const platforms = this.game.gameObjects.find((obj) => obj instanceof Platform);
